<div class="wrap">
	...
	<p>Dieses Plugin zeigt Termine und Details aus einem <a href="https://www.scoutnet.de/kalender/">Scoutnet-Kalender</a> als eigene Seite oder in einem Widget an. Welchen Kalender du anzeigen möchtest, bestimmst du mit der <a href="https://www.scoutnet.de/kalender/kurzanleitung.html">Scoutnet-ID</a>.</p>
	    ...
	    <tr valign="top">
	        ...
	        <td><input type="text" name="scoutnet_kalender_ssid" value="<?php echo get_option('scoutnet_kalender_ssid'); ?>" />
	            <span class="description">
	            	Diese ID wird verwendet wenn du in deinen Seiten oder dem Widget <u>keine</u> ID angibst. Du kannst auch mehrere (und verschiedene) Kalender gleichzeitig nutzen. Gib der jeweiligen Seite oder dem Widget einfach die IDs die du anzeigen möchtest mit.
	            </span>
	        </td>
	    </tr>
	</table>
	...
	<blockquote><ul>
		<li><code>elementcount</code> Gibt dabei die Anzahl der angezeigten Elemente an. Sinnvoll f&uuml;r Seiten ist meistens ein Wert um 30.</li>
		...
		<li><code>ssid</code> Die <a href="https://www.scoutnet.de/kalender/include/einbindung-homepage.html">Scoutnet-ID</a> des anzuzeigenden Kalenders</li>
	</ul></blockquote>
